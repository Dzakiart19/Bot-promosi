...
echo -e "    ${YELLOW}PORT=3010 node bot/threads-bot.js${NC}      (Threads,     port 3010)"
echo ""
...
echo ""
echo -e "  ${CYAN}Catatan Threads Bot:${NC}"
echo -e "    Set secret THREADS_COOKIES = \"sessionid=<val>; csrftoken=<val>\""
echo -e "    (ambil dari DevTools → Application → Cookies → threads.com setelah login)"
echo ""
