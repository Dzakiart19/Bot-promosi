...
module.exports = {
  ...
  // Catatan recon: keyword NSFW (naked, xxx, porn, dll.) diblokir oleh FB search —
  // selalu return 0 hasil. Gunakan keyword populer/viral agar search return video nyata
  // yang bisa dikomentari dengan teks promo.
  SEARCH_KEYWORDS: [
    "funny video", "viral video", "trending video", "dance video",
    "music video", "love song", "travel vlog", "food video",
    "workout video", "motivational video", "prank video", "challenge video",
    "cute video", "amazing video", "best video", "top video",
    "night out", "party video", "beach video", "summer video",
    "short film", "comedy video", "reaction video", "lifestyle vlog",
  ],
