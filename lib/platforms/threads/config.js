...
module.exports = {
  // ── Endpoint ────────────────────────────────────────────────────────────────
  API_BASE:  "https://www.threads.net/api/graphql",
  ...
  DOC_ID_FALLBACK: {
    // BarcelonaSearchResultsQuery — cari thread/postingan berdasarkan keyword
    SearchThreads:   "6623541627726503",
    // BarcelonaTimelineQuery — ambil postingan dari feed/explore (login required)
    GetRecommended:  "25625194612001313",
    // BarcelonaCreateTextPostMutation — buat postingan teks baru
    CreatePost:      "7357111877698751",
    // Mutation reply/comment — sama dengan CreatePost, tapi variables berisi parent_post_id
