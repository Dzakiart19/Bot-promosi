...
module.exports = {
  ...
  // Timing — hanya mode POST (comment dinonaktifkan, tidak berfungsi di GETTR)
  LOOP_DELAY_MS:          900_000,   // 15 menit interval antar post
  REQUEST_TIMEOUT_MS:      15_000,   // timeout per request
  POST_DELAY_MS:            8_000,   // jeda antar komentar dalam satu siklus (unused)
  MAX_COMMENTS_PER_CYCLE:       1,   // 1 komentar per siklus (unused)
  ...
  POST_INTERVAL_MS: 900_000,   // auto-post 1x per 15 menit
